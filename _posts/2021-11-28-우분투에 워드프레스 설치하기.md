...
- 우분투에 APM 설치
  ...
  - MySQL 로그인
    ...
    - ```
        MySQL> GRANT ALL ON wordpress.* TO 'username'@'localhost' WITH GRANT OPTION;
        ```
...
- Wordpress 설정
  ...
  - http://127.0.0.1 접속해 워드프레스 설치 완료
    ...
    - ```
        ...
        ServerAdmin username@userdomain #e메일 주소 입력
